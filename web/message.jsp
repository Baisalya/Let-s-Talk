						...
						<div class="card mb-3">
						  <div class="card-body">
						  	<div class="row">
							  	...
							  	<div class="col-10" style="cursor: pointer;" onclick="window.location.href='ViewMessageServlet?id=<%= messages.get(i).getTo_user() %>'">
								  	<h5 class="card-title"><%= new UserDAO().getUserById(Integer.parseInt(messages.get(i).getTo_user())).getName() %></h5>
							 ...
							 <div class="row">
								<div class="col-12">
						  			<a href="MessageServlet?delete=<%=messages.get(i).getTo_user() %>" class="card-link" style="float: right;"><i style="font-size: 25px;color:red;" class="far fa-trash-alt"></i></a>
						  		</div>							  
						  	 </div>
							</div>
						</div>
					...
					<div class="card mb-3">
					  <div class="card-body">
					  	<div class="row">
						  	...
						  	<div class="col-10" style="cursor: pointer;" onclick="window.location.href='ViewMessageServlet?id=<%= messages.get(i).getTo_user() %>'">
							  	<h5 class="card-title"><%= new UserDAO().getUserById(Integer.parseInt(messages.get(i).getFrom_user())).getName() %></h5>
							    <h6 class="card-subtitle mb-2 text-muted"><%= messages.get(i).getMessage() %></h6>
							    <p class="card-text"><%= messages.get(i).getChat_time() %></p>
						  	</div>
						</div>
						<div class="row">
							<div class="col-12">
						  		<a href="MessageServlet?delete=<%=messages.get(i).getFrom_user() %>" class="card-link" style="float: right;"><i style="font-size: 25px;color:red;" class="far fa-trash-alt"></i></a>
						  	</div>
						</div>
						</div>
					</div>
					...
					<div class="modal-body"
						...
						<%
							...
							<div style="cursor: pointer;  margin: 5px;" class="card"
								onclick="javascript:window.location='ViewMessageServlet?id=<%=newUsers.get(i).getUser_id()%>';">
								<div class="card-body">
